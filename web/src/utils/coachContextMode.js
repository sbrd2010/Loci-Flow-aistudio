...
const BROAD_TASK_QUERY_RE = /\b(what are my tasks|what['’]?s due|what is due|anything due|due date|what['’]?s my deadline|what is my deadline|show my tasks|what do i have today|what tasks do i have|list my tasks|my task list|show my list|what['’]?s on my list|what do i need to do today|check (?:my |the )?(?:today['’]?s|this week['’]?s?|week) (?:focus|horizon)|check (?:this|my) week horizon|check today['’]?s focus|what are my[\w\s'’&/,-]{0,40}priorit(?:y|ies)|tell me my priorities|show me my priorities|what should be my priority|which priority should i focus on|can['’]?t you check|check my week)\b/i;
