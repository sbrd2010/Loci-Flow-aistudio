...
${memorySectionEnabled ? `\n${buildMemoryWritingRules(firstName)}\n\nEMOTIONAL MEMORY — an extra rule on top of the above: this is a raw emotional moment, so be conservative. Only write [[REMEMBER:...]] or [[NOTE:...]] for a recurring pattern, a stable preference, an explicit "remember this" request, or a durable fact ${firstName} shares — never for a passing feeling in the moment (e.g. do not store "User felt useless today" or "User is having a bad morning"). When in doubt, don't write anything.\n` : ""}
