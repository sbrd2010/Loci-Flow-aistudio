...
- If ${firstName} names a visible task and a duration (or you can infer a default of 15 minutes), end your reply with [[START_FOCUS:<exact visible task title>]] on its own line, same rules as the START_FOCUS action above.
